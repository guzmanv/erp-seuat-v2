<?php
  ...
  class SubcampaniaModel extends Mysql{
    ...
    public function insertSubcampania(string $nombreSubcampania, string $fechaInico, string $fechaFin, int $idCampania, int $estatus, string $fechaCreacion, string $fechaActualizacion, int $idUsuarioCreacion, int $idUsuarioActualizacion){
      ...
      if(empty($request)){
        $query_insert = "INSERT INTO t_subcampania(nombre_sub_campania, fecha_inicio, fecha_fin, estatus, fecha_creacion, fecha_modificacion, id_usuario_creacion, id_usuario_modificacion, id_campania) VALUES(?,?,?,?,?,?,?,?,?);";
        $arrData = array($this->strNombreSubcampania, $this->strFechaInicio, $this->strFechaFin, $this->intEstatus, $this->strFechaCreacion, $this->strFechaActualizacion, $this->intIdUsuarioCreacion, $this->intIdUsuarioActualizacion, $this->intIdCampania);
    ...
    public function updateSubcampania(int $id, string $nombreSubcampania, int $estatus, string $fechaActualizacion, int $idUsuarioActualizacion){
      ...
      if(empty($request)){
        $sql = "UPDATE t_subcampania SET nombre_sub_campania = ?, estatus = ?, fecha_modificacion = NOW(), id_usuario_modificacion = ? WHERE id = $this->intIdSubcampania";
        $arrData = array($this->strNombreSubcampania, $this->intEstatus, $this->intIdUsuarioActualizacion);
