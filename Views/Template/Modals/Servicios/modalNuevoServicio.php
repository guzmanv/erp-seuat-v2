                    ...
                    <div class="card-body">
							...
							<div class="form-row">
								<div class="form-group col-sm-12 col-md-6">
									...
									<input type="text" id="txtCodigo_servicio" name="txtCodigo_servicio" class="form-control form-control-sm valid validText" placeholder="Ingrese el código para indentificar el servicio"  name="Ingrese el código para indentificar el servicio" required="" >
								</div>
							</div>
							...
							<div class="form-row">
								<div class="form-group col-sm-12 col-md-10">
									...
									<input type="text" id="txtNombre_servicio" name="txtNombre_servicio" class="form-control form-control-sm valid validText" placeholder="Ingrese el nombre del nuevo servicio"  name="Ingrese el nombre del nuevo servicio" required="" >
								</div>
								<div class="form-group col-sm-12 col-md-2">
									<label for="txtPrecio_unitario">Precio </label>
									<input type="text" id="txtPrecio_unitario" name="txtPrecio_unitario" class="form-control form-control-sm valid validText" placeholder="Precio"  name="Ingrese el precio del servicio" required="" >
								</div>
							</div>
