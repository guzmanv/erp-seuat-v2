                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" id="txtClaveInstitucionEdit" name="txtClaveInstitucionEdit" class="form-control form-control-sm" placeholder="Clave de institución" maxlength="30">
                                            </div>
                                            <div class="form-group col-md-4">
                ...
                <div class="card card-secondary">
                    <nav>
                        <div class="nav nav-pills nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-link tab-navEdit" id="step1-tab" data-toggle="tab" href="" onclick="fnNavTabEdit(0)">Plantel</a>
                            <a class="nav-link tab-navEdit" id="step2-tab" data-toggle="tab" href="" onclick="fnNavTabEdit(1)">Sistema</a>
                            <a class="nav-link tab-navEdit" id="step3-tab" data-toggle="tab" href="" onclick="fnNavTabEdit(2)">Legal</a>
                            <a class="nav-link tab-navEdit" id="step4-tab" data-toggle="tab" href="" onclick="fnNavTabEdit(3)">Ubicación</a>
                            <a class="nav-link tab-navEdit" id="step5-tab" data-toggle="tab" href="" onclick="fnNavTabEdit(4)">Logos</a>
                        </div>
                    </nav>
                    <form id="formEditPlantel" method = "POST" name="formEditPlantel" enctype="multipart/form-data">
                        <input type="hidden" id="idPlantelEdit" name="idPlantelEdit" value="">
