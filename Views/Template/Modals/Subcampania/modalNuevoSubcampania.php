          ...
          <form class="formSubcampania" id="formSubcampania" name="formSubcampania" autocomplete="off">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="txtNombreSubcampania" name="txtNombreSubcampania" class="form-control valid validText" placeholder="Ingrese una nueva Subcampaña" name="Ingresa el nombre de la Subcampaña" required="" autofocus>
              </div>

              <div class="form-group">
                <label for="txtFechaInicio">Fecha de inicio (<span class="required">*</span>)</label>
                <input type="date" id="txtFechaInicio" name="txtFechaInicio" class="form-control valid validText" placeholder="Inicio de la Subcampaña" name="Ingrese la fecha de Inicio" value="<?php echo date("Y-m-d"); ?>" required="" autofocus>
              </div>

              <div class="form-group">
                <label for="txtFechaFin">Fecha Limite (<span class="required">*</span>)</label>
                <input type="date" id="txtFechaFin" name="txtFechaFin" class="form-control valid validText" placeholder="Fin de la Subcampaña" name="Fecha limite" required="" autofocus>
              </div>
