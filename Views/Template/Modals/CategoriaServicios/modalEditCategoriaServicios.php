<div class="modal fade" id="modalFormCategoria_servicios_editar" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form id="formCategoria_serviciosup" name="formCategoria_serviciosup" autocomplete="off">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" id="txtNombre_categoriaup" name="txtNombre_categoriaup" class="form-control valid validText" placeholder="Ingrese una nueva categoría"  name="Ingresa el nombre de la categoría" required="">
                      </div>
                      <div class="form-group">
