                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"><input type="text" id="txtNombreNuevo" name="txtNombreNuevo" class="form-control" placeholder="Nombre de la Persona"  name="" readonly required></div>
                                                <div class="col-md-3"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalNombrePersona"><i class="fa fa-search"></i> Buscar</button></div>
                                            </div>    
                                        </div>
                                    </div>
